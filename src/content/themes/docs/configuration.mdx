...
export default {
  ...
  titleSuffix: ' – MarkdownOffice',
  footerText: `MIT ${new Date().getFullYear()} © MarkdownOffice.`
}
```
...
**Default:** `https://github.com/markdownoffice/markdownoffice`
...
```js filename="theme.config.js"
export default {
  docsRepositoryBase: 'https://github.com/markdownoffice/markdownoffice'
}
```
...
```js filename="theme.config.js"
export default {
  footerText: ({ locale }) => `MIT ${new Date().getFullYear()} © MarkdownOffice.`
}
```
...
export default {
  head: (
    <>
      ...
      <meta name="twitter:site" content="@markdownoffice" />
      <meta property="og:title" content="MarkdownOffice: The Markdown-native, LLM-first office suite" />
      <meta property="og:description" content="MarkdownOffice: The Markdown-native, LLM-first office suite" />
